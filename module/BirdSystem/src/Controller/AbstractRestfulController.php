...
{
    use LoggerAwareTrait, TranslatorAwareTrait, AuthenticationTrait;
    ...
    /**
     * @var \BirdSystem\Db\TableGateway\AbstractTableGateway
     */
    ...
    {
        /**
         * @var \BirdSystem\Db\Model\AbstractModel $Model
         */
