<?php
namespace BirdSystem\Db\TableGateway;

use BirdSystem\Controller\Exception\AppException;
use BirdSystem\Db\Model\AbstractModel;
use BirdSystem\Db\TableGateway\Exception\IncompleteCompositeKeyException;
use BirdSystem\Db\TableGateway\Exception\SeekException;
 ...
 *
 * @package BirdSystem\Db\TableGateway
    ...
    TranslatorAwareInterface
{
    ...
    public function decodeCompositeKey($keyString)
    {
        ...
        /**
         * @var \BirdSystem\Db\Model\CompanyConfig $Model
         */
     ...
     * @param int          $offset
     *
     * @return array|\ArrayObject|null|\BirdSystem\Db\Model\AbstractModel
     * @throws SeekException
     */
